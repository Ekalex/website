...
const AboutSectionOne = () => {
  ...
  return (
    ...
    <p>Later, at Branch Line, I found a new appreciation for the quality of food we could create. The restaurant has a focus on rotisserie cooking and farm-to-table practices pushed me to take my skills up a notch. It was a great experience, working with fresh, locally sourced ingredients and creating dishes that were genuinely appreciated.</p><br></br>
