                      ...
                      >
                        <div className="relative">
                          <input
                            ...
                            className="sr-only"
                          />
                          <div className="box mr-4 flex h-5 w-5 items-center justify-center rounded border border-body-color border-opacity-20 dark:border-Gray dark:border-opacity-10">
